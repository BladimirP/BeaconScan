...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Configura un observador LiveData para los datos de los beacons
        val regionViewModel = BeaconManager.getInstanceForApplication(this).getRegionViewModel(beaconReferenceApplication.region)
        // El observador se llamará cada vez que el estado de la región monitorizada cambie (dentro o fuera de la región)
        regionViewModel.regionState.observe(this, monitoringObserver)
        // El observador se llamará cada vez que se detecte una nueva lista de beacons (típicamente ~1 segundo en primer plano
